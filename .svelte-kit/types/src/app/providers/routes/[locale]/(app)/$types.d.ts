...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/app/providers/routes/[locale]/(app)/+page.server.js').load>>>>>>;
