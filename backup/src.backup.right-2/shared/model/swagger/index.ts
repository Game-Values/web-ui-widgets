...
export namespace Api {
	...
	/**
	 * @description First step with OAuth2 compatible token auth, get an access token for future requests. The chat_token is used to authenticate with the chat server. In case if the chat server is not available, the user can still auth, but will not be able to use the chat and chat_token will be empty.
	 * @tags auth
