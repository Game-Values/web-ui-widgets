<template>
  <footer class="mt-24 bg-gray-900 sm:mt-12  bg-transparent">
    <div class="mx-auto max-w-md overflow-hidden py-12 px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <p class="mt-8 text-center text-base text-gray-400">&copy; {{ new Date().getFullYear() }} {{ siteName }}. All
        rights reserved.</p>
    </div>
  </footer>
</template>
...
const footerNavigation = {
  ...
  social: [
    {
      name: "GitHub",
      href: "https://github.com/game-values",
