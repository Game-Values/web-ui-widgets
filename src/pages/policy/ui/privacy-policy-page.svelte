...
<div class="gap-y-4 flex flex-col text-sm text-secondary">
    ...
    <p>
        (<q>Company</q>, <q>Game Values</q>,) undertakes to protect Personal
        Data collected or received from visitors (<q>Visitors</q>) to <SiteLink />
        website (<q>Site</q>) and other interactive means used, which have a link to this Privacy Policy.
        It also describes how we use Personal Information collected when you register as a User (<q>User</q>)
        In this Privacy Policy (<q>Policy</q>), we explain how your personal data, namely any information relating
        to a directly or indirectly identified or identifiable individual (the <q>Personal Data Subject</q>)
        that we may hold about you (<q>Personal Data</q>) is collected, used, stored, transferred, disclosed
        and deleted (referred to as <q>processing</q> below).
    </p>

    <p>
        Policy regarding the processing of personal data is made in accordance with paragraph 2 of Art. 18.1
        of the Russian Federation Federal Law <q>On Personal Data</q> No. 152-FZ of
        <time datetime="2006-07-27">July 27, 2006</time> and applies to all Personal Data processed by
        BITS CONSULTING LLC, which can be obtained from a natural person - User and / or Website visitor.
    </p>
    ...
    <p>
        The legal basis for this Policy is the Federal Law of the Russian Federation <q>On Personal Data</q> No.
        152-FZ of <time datetime="2006-07-27">July 27, 2006</time> (Federal Law <q>On Personal Data</q>).
    </p>
    ...
    <ol>
                ...
                <dd>
                    <ul>
                        ...
                        <li>
                            ...
                            User registered on the Site for his further authorization, order placement and other actions
                            on the Site, to provide the User access to the personalized data of the Site. Required for
        ...
        <li>
            <h5>
                REGISTRATION OF THE USER'S PERSONAL ACCOUNT USING SOCIAL NETWORKS
            </h5>

            <dl>
                <dt>
                    In order to optimize the Site and interaction with the User, the Site has the right to collect the
                    data about the User specified in this section from social networks:
                </dt>
            ...
            <p>
                User registration on the Site can be done through the social service
                <a class="link link-primary link-hover" href="https://www.facebook.com" target="_blank">facebook.com</a>.
                This method of authorization is chosen by the User by performing the actions specified on the Site at
            ...
            <dl>
                <dt>
                    ...
                    User from the vk.com system in order to automatically fill in similar data about the User, as well
                    as to optimize the Site filter by the relevant criterion:
                </dt>
                ...
                <dd>
                    <ul>
                        ...
                        <li>
                            ...
                            to monitor any User Account to prevent, investigate and/or report fraud, terrorism,
                            misrepresentation, security incidents or crime, in accordance with applicable law; and
                        </li>
        ...
        <li>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        ...
                        <li>
                            Governmental authorities and/or law enforcement officials, if required by law or required
                            for the legal protection of our own legitimate interests under applicable law.
                        </li>
                    </ul>
                </dd>
            </dl>
            ...
            <p>
                <q>BITS CONSULTING</q> LLC transfers your Personal Data, as a rule, to countries that provide adequate
            ...
            <p>
                ...
                contacting us at the address specified in the <q>How to Contact Us</q> section.
            </p>
        ...
        <li>
            ...
            <p>
                When collecting your Personal Data, <q>BITS CONSULTING</q> LLC provides recording, systematization,
        ...
        <li>
                ...
                <dd>
                    <ol>
                        <li>
                            <dl>
                                <dt>
                                    Strictly necessary files Cookie
                                </dt>

                                <dd>
                                    Some cookies are required for the operation of the Sites. For example, some cookies
                                    allow us to identify registered Users and provide them access to the Site. If a
                                    registered User chooses to disable these cookies, the User may not be able to access
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    and to monitor the effectiveness of the Site. This allows us to provide a
                                    high-quality experience by customizing the offering and quickly identifying and
                                    resolving any issues that arise. For example, performance cookies may be used to
                                    track which pages are most popular and to determine why certain pages receive error
                                    messages.
                                </dd>
                            </dl>
                        </li>
            ...
            <h3>
                <a
                    class="link link-hover"
                    href="https://360suite.google.com"
                    target="_blank"
                >
                    Google Analytics
                </a>
            ...
            <p>
                ...
                <a class="link link-primary link-hover" href="https://www.google.com/policies/privacy/partners" target="_blank">https://www.google.com/policies/privacy/partners</a>
            </p>
            ...
            <p>
                ...
                <a class="link link-primary link-hover" href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>
            </p>
            ...
            <p>
                ...
                <a class="link link-primary link-hover" href="http://www.allaboutcookies.org/manage-cookies" target="_blank">http://www.allaboutcookies.org/manage-cookies</a>
            </p>

            <p>
                More information on how companies use cookies can be found here
                <a class="link link-primary link-hover" href="http://www.allaboutcookies.org" target="_blank">http://www.allaboutcookies.org</a>
            </p>
        </li>
        ...
        <li>
            ...
            <p>
                Here we have summarized the basic rights that you have under the Federal Law <q>On Personal Data</q>.
            </p>
        ...
        <li>
            ...
            <dl>
                ...
                <dd>
                    <ol>
                        <li>
                            Determination of threats to the security of Personal Data during their processing in
                        ...
                        <li>
                            The use of duly approved conformity assessment procedures for information protection
                            tools;
                        </li>

                        <li>
                            Evaluation of the effectiveness of measures to ensure the security of personal data prior to
                        ...
                        <li>
                            Establishing rules for access to Personal Data processed in the information system of
