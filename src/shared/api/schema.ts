...
export class Api<SecurityDataType extends unknown> {
  ...
  api = {
    ...
    validateMagicLinkApiV1LoginClaimPost: (data: IWebTokenRaw, params: RequestParams = {}) =>
      this.http.request<IValidateMagicLinkApiV1LoginClaimPostDataRaw, IValidateMagicLinkApiV1LoginClaimPostErrorRaw>({
     ...
     * @response `422` `IHTTPValidationErrorRaw` Validation Error
     */
    resetPasswordApiV1LoginResetPost: (data: IBodyResetPasswordApiV1LoginResetPostRaw, params: RequestParams = {}) =>
    ...
    toggleStateApiV1UsersToggleStatePost: (data: IUserUpdateRaw, params: RequestParams = {}) =>
      this.http.request<IToggleStateApiV1UsersToggleStatePostDataRaw, IToggleStateApiV1UsersToggleStatePostErrorRaw>({
    ...
    deleteItemApiV1ItemsItemItemIdDelete: (itemId: string, params: RequestParams = {}) =>
      this.http.request<IDeleteItemApiV1ItemsItemItemIdDeleteDataRaw, IDeleteItemApiV1ItemsItemItemIdDeleteErrorRaw>({
        path: `/api/v1/items/item/${itemId}`,
        method: "DELETE",
        secure: true,
        ...params,
