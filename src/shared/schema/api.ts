...
export namespace Api {
	...
	/**
	 * @description First step with OAuth2 compatible token login, get an access token for future requests. The chat_token is used to authenticate with the chat.ts server. In case if the chat.ts server is not available, the user can still login, but will not be able to use the chat.ts and chat_token will be empty.
	 * @tags login
...
export class Api<SecurityDataType extends unknown> {
	...
	api = {
		...
		createGameApiV1GamesPost: (
			data: IBodyCreateGameApiV1GamesPost,
		 ...
		 * @response `422` `IHTTPValidationError` Validation Error
		 */
		readAllGamesApiV1GamesGet: (
			query: IReadAllGamesApiV1GamesGetParams,
			params: RequestParams = {}
		) =>
		 ...
		 * @response `422` `IHTTPValidationError` Validation Error
		 */
		readAllItemsApiV1ItemsAllGet: (
			query: IReadAllItemsApiV1ItemsAllGetParams,
			params: RequestParams = {}
		) =>
			this.http.request<
		...
		readAllUsersApiV1UsersAllGet: (
			query: IReadAllUsersApiV1UsersAllGetParams,
			params: RequestParams = {}
		) =>
			this.http.request<
		...
		resetPasswordApiV1LoginResetPost: (
			data: IBodyResetPasswordApiV1LoginResetPost,
			params: RequestParams = {}
		) =>
			this.http.request<
		 ...
		 * @response `422` `IHTTPValidationError` Validation Error
		 */
		updateItemApiV1ItemsItemItemIdPut: (
			itemId: string,
			data: IItemUpdate,
			params: RequestParams = {}
		) =>
		 ...
		 * @response `422` `IHTTPValidationError` Validation Error
		 */
		updateOrderApiV1OrderOrderIdPut: (
			orderId: string,
			data: IOrderBase,
			params: RequestParams = {}
		) =>
